...
export default function AdminAddBadal() {
  ...
  const { data, setData, post, processing, errors, reset } = useForm({
    img_url: '',
    title: '',
    kategori: 'Haji', // Default value
    harga: '',
    konten: ''
  });

  // Pilihan kategori badal
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post(route('badal.store'));
  };

  return (
    <AuthenticatedLayout>
      <Head title="Tambah Paket Badal" />

      <div className="container py-4">
        <h2 className="fw-bold mb-4">Tambah Paket Badal</h2>
        
        <form onSubmit={handleSubmit} encType="multipart/form-data">
            {/* Informasi Dasar */}
            <div className="form-section">
              <h3 className="form-section-title">Informasi Paket Badal</h3>
